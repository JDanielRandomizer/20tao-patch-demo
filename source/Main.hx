...
class Main extends Sprite
{
	...
	public static final savePath:String = "PlayTvGames/FazOPix";
	...
	public static function switchState(?target:NextState, transition:String = '20tao'):Void
	{
	...
	public static function resetState(transition:String = '20tao'):Void
