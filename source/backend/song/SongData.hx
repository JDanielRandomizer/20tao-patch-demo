...
class SongData
{
	...
	public static var weeks:Array<FunkyWeek> = [
		{
			songs: [
				['como-cantar', 'girlfriend', 'como cantar'],
				['play-tv', 'playtv', 'Play Tv'],
				['paralanches', 'para', '#ParaLanches'],
				['papai-calabreso', 'davibrito', 'Papai Calabreso'],
				['slk-tralaleiro-tralala-ta-todo-safadeza', 'tralaleiro', 'SLK Tralalero Tralala Ta Todo SAFADEZA'],
				['chaves', 'nhonho', 'MeuZovo'],
				['buraquinho', 'buraquinho', 'me da seu ratinho'],
				['calvice-prematura', 'bebe', 'calvice prematura'],
				['silly-beta', 'silly', 'Silly Beta'],
			],
			weekFile: '20tao',
			weekName: '20tao',
		},
