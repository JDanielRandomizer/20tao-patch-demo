...
class CoolUtil
{
	...
	*/
	...
	// my life be like
	public static function getLangText(theLine)
	{
		trace(Main.lang);

		var valueToReturn = cast Paths.json('textMegaJson').thisShit;
		return valueToReturn[theLine][Main.lang];
	}

	public static function getDescDescs(theLine)
	{
		var valueToReturn = cast Paths.json('textMegaJson').galleryStuff;
		return valueToReturn[theLine][Main.lang];
	}
}