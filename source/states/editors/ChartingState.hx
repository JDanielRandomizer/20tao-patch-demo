...
class ChartingState extends MusicBeatState
{
	...
	public static final possibleEvents:Array<Array<String>> = [
		['none', 				''],
		['Show Credits', 	''],
		['Cinematic Move', 	'Value 1: X of bar1 \nValue 2: X of bar2'],
		['Song Script Event', 	"WHY DIDN'T MADE THIS BEFORE????\nSilly beta would be much easier to port :((("],
		// CAMERA (permanent)
		...
		['Change Cam Visibility', 	'Value 1: Change The Camera Visibility (true/false)'],
		// CAMERA (temporary)
		...
		['Beat Screen',		'Value 1: The beat zoom\nValue 2: The zoom it need to end\nValue 3: Duration in seconds'],
		['Zoom Screen',		'Value 1: Zoom to\nValue 2: Duration in seconds'],
		['360 screen',		'Value 1: Duration in seconds'],
		['Flash Image',		'Value 1: The image name\nValue 2: Duration in seconds'],
		['Fade BG and Stuff', 'It low taper the fades (used in "me da seu ratinho" for objs that can\'t be modified in the ratinho script)'],
		// game objects
